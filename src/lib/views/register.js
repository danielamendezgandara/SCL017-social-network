...
<div class="modal-content">
  ...
  <form id="formAccCreation">
    <input type="email" id="mail-creation" placeholder=" " pattern="[a-z0-9._%+-]+@[a-z0-9.-]+[a-z]{2,4}$" title="Ej. usuario@abcd.com" required>
    <input type="password" id="pass-creation" placeholder=" " pattern="(?=.*)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Debe contener: 6 caracteres, al menos una mayúscula, una minúscula y un número" required>
    <p id="message"></p><br/>
  ...
  const btnModal = registerPage.querySelector('#btn');
  ...
  btnModal.addEventListener('click', signInUserEmailPassword, false);
